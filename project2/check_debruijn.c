...
main(){
    ...
    if(readseq(fp,sequence)) {
        if(checkseq(sequence,states)) {
	        printf("Sequence has correct length and is a De Bruij sequence. \n");
        } else {
            printf("Sequence containts correct length \n");
            printf("but it is not an De Bruijn sequence\n");
        }
    } else {
	        printf("Sequence has not correct length\n");
            if(checkseq(sequence,states)) {
                printf("But is a De Bruijn sequence \n");
            } else {
                printf("Seqeunce neither has correct length or is a De Bruijn seqeence. \n");
        }
    }
}
